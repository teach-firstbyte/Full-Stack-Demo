...
function renderToday() {
  ...
  var count = habits.filter(function(h) { return h.completed; }).length; // how many are ticked today
...
async function toggleHabit(id) {
  // updated = returns the completed status of the habit (after being toggled on/off by backend)
...
async function addHabit() {
  ...
  // ADD in your add habit logic here to interact with the backend!
  // Note: Don't forget to turn on the backend server by running "npm run dev" in the backend directory!


  habits.push(habitResponse); // Add it to our list
